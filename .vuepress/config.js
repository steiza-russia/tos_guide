      ...
      '/docs/clients/': [
        {
          ...
          children: [
            ...
            '/docs/clients/Как создать сотрудника',
      ...
      '/docs/': [
        {
          ...
          children: [
            '/docs/Как добавить клиента в систему',
            {
              text: 'Сотрудники',
              children: [
                '/docs/empls_page/Управление сотрудниками и правами',
                '/docs/empls_page/Удаление прав сотруднику',
              ]
            },
            {
              text: 'Заявки',
              children: [
                ...
                '/docs/Как удалить заявку?',
              ]
            },
            {
              text: 'Тарифы и услуги',
              children: [
                '/docs/tariffs/Как создать клиентские тарифы',
              ]
            },
            {
              text: 'Прием/Выдача',
